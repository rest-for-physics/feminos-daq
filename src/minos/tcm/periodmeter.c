/*******************************************************************************
 ...
 Description: Measure performance of TCM:
 ...
 History:
  ...
  February 2013: created from busymeter.c
...
// Global variables
unsigned int __attribute__((section(".hevper"))) hevper[EHISTO_SIZE];
histoint evper_histogram;

/*******************************************************************************
 Periodmeter_PacketizeHisto()
*******************************************************************************/
